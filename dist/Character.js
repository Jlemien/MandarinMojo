...
game.Character.prototype.draw = function (camerapos) {
    if (this.visible) {
        drawText(gContext, this.character, gWorld.textsize, 'yellow', this.pos[0] + camerapos[0], this.pos[1] + camerapos[1], 1.0, this.alignment);
    }
    if (gWorld.debug) {
        // Character position.
        drawRect(gContext, this.getCollisionPos()[0] + camerapos[0], this.getCollisionPos()[1] + camerapos[1], 2, 2);
